...
global.items = {
    ...
    shield_wooden:	{ id: "shield_wooden",	image_index: 2,		name: "Wooden Shield",  weight: 5,		value: 8,	type: "shield",      stack_size: 2 },
	shield_steel:	{ id: "shield_steel",	image_index: 3,		name: "Steel Shield",	weight: 10,		value: 12,	type: "shield",      stack_size: 2 },
    ...
    pickaxe:		{ id: "pickaxe",		image_index: 7,		name: "Pickaxe",		weight: 6,		value: 3,	type: "tool",		stack_size: 8 },
    shovel:			{ id: "shovel",			image_index: 8,		name: "Shovel",			weight: 5,		value: 2,	type: "tool",		stack_size: 8 },
